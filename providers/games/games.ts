...
export class GamesProvider {
    ...
    getLhcNums($code) {
        var codeNums = {
            ...
            '红合单': ("1,7,12,18,23,29,30,34,45").split(','),
            '红合双': ("2,8,13,19,24,35,40,46").split(','),
            '蓝合单': ("3,9,14,25,36,41,47").split(','),
            '蓝合双': ("4,10,15,20,26,31,37,42,48").split(','),
            '绿合单': ("5,16,21,27,32,38,43,49").split(','),
            '绿合双': ("6,11,17,22,28,33,39,44").split(','),
            '鼠': ("11,23,35,47").split(','),
            '牛': ("10,22,34,46").split(','),
            '虎': ("9,21,33,45").split(','),
            '兔': ("8,20,32,44").split(','),
            ...
            '猴': ("3,15,27,39").split(','),
            '鸡': ("2,14,26,38").split(','),
            '狗': ("1,13,25,37,49").split(','),
            '猪': ("12,24,36,48").split(','),
            '0尾': ("10,20,30,40").split(','),
            '1尾': ("01,11,21,31,41").split(','),
            '2尾': ("02,12,22,32,42").split(','),
            '3尾': ("03,13,23,33,43").split(','),
            '4尾': ("04,14,24,34,44").split(','),
            '5尾': ("05,15,25,35,45").split(','),
            '6尾': ("06,16,26,36,46").split(','),
            '7尾': ("07,17,27,37,47").split(','),
            '8尾': ("08,18,28,38,48").split(','),
            '9尾': ("09,19,29,39,49").split(','),
        };
